...
<div className=''>   <h3 className=' bg-clip-text text-transparent bg-gradient-to-r from-lightBlue to-amber1 font-bold  text-2xl  text-left  text-lightBlue py-2' id="services">An Enthusiastic Developer Driven by creativity  </h3>
