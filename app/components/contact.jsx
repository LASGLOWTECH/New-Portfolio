...
<section className='bg-cover bg-[url(/myweb.jpg)]  md:bg-fixed bg-center '  >

<div className='py-8 px-6  overlay relative w-full h-full backdrop-brightness-50 flex justify-center items-center flex-col'>
             

<form className=" flex flex-col justify-center md:w-auto w-full  px-6 md:px-20  bg-opacity-80 rounded-2xl bg-darkestBlue shadow-lg " onSubmit={onSubmit}>
...
<input type="submit" className="text-lg text-white flex place-self-start rounded-md px-16 py-2  my-3 bg-amber2" value="Submit"/>
      ...
      <p className=" text-base text-darkGreen ps-5 py-2">{result} </p>
